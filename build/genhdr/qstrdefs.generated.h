...
QDEF1(MP_QSTR_account_balance, 56061, 15, "account_balance")
QDEF1(MP_QSTR_account_locked_balance, 19048, 22, "account_locked_balance")
...
QDEF1(MP_QSTR_alt_bn128_g1_multiexp, 15814, 21, "alt_bn128_g1_multiexp")
QDEF1(MP_QSTR_alt_bn128_g1_sum, 63689, 16, "alt_bn128_g1_sum")
QDEF1(MP_QSTR_alt_bn128_pairing_check, 8664, 23, "alt_bn128_pairing_check")
...
QDEF1(MP_QSTR_attached_deposit, 58560, 16, "attached_deposit")
...
QDEF1(MP_QSTR_block_height, 5132, 12, "block_height")
QDEF1(MP_QSTR_block_timestamp, 58525, 15, "block_timestamp")
QDEF1(MP_QSTR_bound_method, 41623, 12, "bound_method")
QDEF1(MP_QSTR_buffer, 41189, 6, "buffer")
QDEF1(MP_QSTR_build_contract, 52766, 14, "build_contract")
...
QDEF1(MP_QSTR_current_account_id, 1472, 18, "current_account_id")
...
QDEF1(MP_QSTR_ecrecover, 40025, 9, "ecrecover")
QDEF1(MP_QSTR_ed25519_verify, 59286, 14, "ed25519_verify")
...
QDEF1(MP_QSTR_epoch_height, 34772, 12, "epoch_height")
...
QDEF1(MP_QSTR_input_as_str, 11380, 12, "input_as_str")
...
QDEF1(MP_QSTR_keccak256, 48336, 9, "keccak256")
QDEF1(MP_QSTR_keccak512, 47255, 9, "keccak512")
...
QDEF1(MP_QSTR_log_utf16, 57438, 9, "log_utf16")
...
QDEF1(MP_QSTR_msgpack, 25413, 7, "msgpack")
...
QDEF1(MP_QSTR_packb, 2398, 5, "packb")
QDEF1(MP_QSTR_panic, 7376, 5, "panic")
QDEF1(MP_QSTR_panic_utf8, 432, 10, "panic_utf8")
...
QDEF1(MP_QSTR_predecessor_account_id, 60756, 22, "predecessor_account_id")
QDEF1(MP_QSTR_prepaid_gas, 44052, 11, "prepaid_gas")
QDEF1(MP_QSTR_print_exception, 8732, 15, "print_exception")
QDEF1(MP_QSTR_promise_and, 16526, 11, "promise_and")
QDEF1(MP_QSTR_promise_batch_action_add_key_with_full_access, 33028, 45, "promise_batch_action_add_key_with_full_access")
QDEF1(MP_QSTR_promise_batch_action_add_key_with_function_call, 20051, 47, "promise_batch_action_add_key_with_function_call")
QDEF1(MP_QSTR_promise_batch_action_create_account, 51773, 35, "promise_batch_action_create_account")
QDEF1(MP_QSTR_promise_batch_action_delete_account, 1888, 35, "promise_batch_action_delete_account")
QDEF1(MP_QSTR_promise_batch_action_delete_key, 2902, 31, "promise_batch_action_delete_key")
QDEF1(MP_QSTR_promise_batch_action_deploy_contract, 61121, 36, "promise_batch_action_deploy_contract")
QDEF1(MP_QSTR_promise_batch_action_function_call, 46104, 34, "promise_batch_action_function_call")
QDEF1(MP_QSTR_promise_batch_action_function_call_weight, 3655, 41, "promise_batch_action_function_call_weight")
QDEF1(MP_QSTR_promise_batch_action_stake, 19983, 26, "promise_batch_action_stake")
QDEF1(MP_QSTR_promise_batch_action_transfer, 1612, 29, "promise_batch_action_transfer")
QDEF1(MP_QSTR_promise_batch_create, 24098, 20, "promise_batch_create")
QDEF1(MP_QSTR_promise_batch_then, 5073, 18, "promise_batch_then")
QDEF1(MP_QSTR_promise_create, 6977, 14, "promise_create")
QDEF1(MP_QSTR_promise_result, 55020, 14, "promise_result")
QDEF1(MP_QSTR_promise_result_as_str, 17675, 21, "promise_result_as_str")
QDEF1(MP_QSTR_promise_results_count, 31715, 21, "promise_results_count")
QDEF1(MP_QSTR_promise_return, 30735, 14, "promise_return")
QDEF1(MP_QSTR_promise_then, 31666, 12, "promise_then")
QDEF1(MP_QSTR_promise_yield_create, 48931, 20, "promise_yield_create")
QDEF1(MP_QSTR_promise_yield_resume, 2622, 20, "promise_yield_resume")
...
QDEF1(MP_QSTR_random_seed, 8886, 11, "random_seed")
QDEF1(MP_QSTR_randrange, 16035, 9, "randrange")
QDEF1(MP_QSTR_re, 28882, 2, "re")
QDEF1(MP_QSTR_read_register, 48033, 13, "read_register")
QDEF1(MP_QSTR_read_register_as_str, 24038, 20, "read_register_as_str")
...
QDEF1(MP_QSTR_register_len, 15700, 12, "register_len")
QDEF1(MP_QSTR_rel_tol, 18006, 7, "rel_tol")
QDEF1(MP_QSTR_reversed, 28321, 8, "reversed")
QDEF1(MP_QSTR_ripemd160, 25685, 9, "ripemd160")
...
QDEF1(MP_QSTR_signer_account_id, 42285, 17, "signer_account_id")
QDEF1(MP_QSTR_signer_account_pk, 42587, 17, "signer_account_pk")
...
QDEF1(MP_QSTR_storage_has_key, 21937, 15, "storage_has_key")
QDEF1(MP_QSTR_storage_read, 49041, 12, "storage_read")
QDEF1(MP_QSTR_storage_remove, 5829, 14, "storage_remove")
QDEF1(MP_QSTR_storage_usage, 7398, 13, "storage_usage")
QDEF1(MP_QSTR_storage_write, 65022, 13, "storage_write")
...
QDEF1(MP_QSTR_test_account_id, 59775, 15, "test_account_id")
QDEF1(MP_QSTR_test_add_extra_balance, 5329, 22, "test_add_extra_balance")
QDEF1(MP_QSTR_test_method, 58323, 11, "test_method")
...
QDEF1(MP_QSTR_unpackb, 48261, 7, "unpackb")
QDEF1(MP_QSTR_unregister, 54295, 10, "unregister")
QDEF1(MP_QSTR_used_gas, 65512, 8, "used_gas")
QDEF1(MP_QSTR_usys, 62409, 4, "usys")
QDEF1(MP_QSTR_validator_stake, 20972, 15, "validator_stake")
QDEF1(MP_QSTR_validator_total_stake, 57393, 21, "validator_total_stake")
...
QDEF1(MP_QSTR_write_register, 34798, 14, "write_register")
